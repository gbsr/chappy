...
export function logWithLocation(message, level = "info") {
    ...
    logLevel.logFunction(`${logLevel.color}--- ${COLOR_RESET}${fileName}${COLOR_BLUE}:${COLOR_ORANGE}${line},${COLOR_RESET} *${logLevel.color}${BOLD} [${logLevel.name}]${COLOR_RESET} * ${COLOR_BLUE}:${timestamp}:${logLevel.color}\n --- ${message}\n${logLevel.color}--- \n`);
}
// Usage examples
